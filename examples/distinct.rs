...
use pkcore::arrays::matchups::masked::{
    MASKED_UNIQUE_TYPE_FIVE_A, MASKED_UNIQUE_TYPE_FIVE_B, MASKED_UNIQUE_TYPE_FIVE_C, MASKED_UNIQUE_TYPE_FIVE_D,
    ...
    MASKED_UNIQUE_TYPE_TWO_C, MASKED_UNIQUE_TYPE_TWO_D, MASKED_UNIQUE_TYPE_TWO_E, Masked,
};
