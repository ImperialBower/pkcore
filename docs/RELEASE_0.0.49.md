...
from escalating into an unconditional raise loop. See `docs/DEFECT_bot-escalation.md`.
...
| `docs/DEFECT_bot-escalation.md` | Post-mortem: deterministic raise-war escalation under equity-based decisions; probabilistic gate fix |
| `docs/DEFECT_ShortStack_BB_Call_Amount.md` | Post-mortem: short-stack BB setting incorrect call target for other players |
...
`docs/DEFECT_ShortStack_BB_Call_Amount.md` *(new)*,
`docs/DEFECT_bot-escalation.md` *(new)*,
