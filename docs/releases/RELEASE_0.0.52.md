...
recorded in [`docs/defects/DEFECT_003_heads_up_side_pot.md`](../defects/DEFECT_003_heads_up_side_pot.md);
...
- **[`docs/defects/DEFECT_003_heads_up_side_pot.md`](../defects/DEFECT_003_heads_up_side_pot.md)** —
...
`docs/defects/DEFECT_003_heads_up_side_pot.md` *(new, +391)*,
