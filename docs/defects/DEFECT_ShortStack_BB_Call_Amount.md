...
**Cross-reference:** `docs/defects/BUGFIX_short_blind_call_target.md`
...
The current correct behavior is described in `docs/defects/BUGFIX_short_blind_call_target.md`. **Do not use the rule statement below as authoritative** — it represents the rejected interpretation.
...
This is the universal rule used at WSOP, WPT, and every regulated cardroom. See `docs/defects/BUGFIX_short_blind_call_target.md` for the worked scenarios and chip-conservation math.
...
See `docs/defects/BUGFIX_short_blind_call_target.md` for the full corrected design and the chip-conservation regression tests added alongside the revert.
