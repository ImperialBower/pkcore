...
impl From<Combo> for Twos {
    ...
    fn from(combo: Combo) -> Self {
        match combo {
            ...
            Combo::COMBO_87_PLUS => range!(87+),
            Combo::COMBO_87s_PLUS => range!(87s+),
            Combo::COMBO_87o_PLUS => range!(87o+),
            ...
            Combo::COMBO_76_PLUS => range!(76+),
            Combo::COMBO_76s_PLUS => range!(76s+),
            Combo::COMBO_76o_PLUS => range!(76o+),
            ...
            Combo::COMBO_65_PLUS => range!(65+),
            Combo::COMBO_65s_PLUS => range!(65s+),
            Combo::COMBO_65o_PLUS => range!(65o+),
            ...
            Combo::COMBO_54_PLUS => range!(54+),
            Combo::COMBO_54s_PLUS => range!(54s+),
            Combo::COMBO_54o_PLUS => range!(54o+),
            ...
            Combo::COMBO_32 | Combo::COMBO_32_PLUS => range!(32),
