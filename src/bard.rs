...
/// them to sort naturally the way a player would expect them to sort.
///
/// FUCK IT! I'm going for it.
///
/// The truth is that it doesn't really matter where the bits are, from `Bard`'s perspective. So,
/// why not infuse the type with some superpowers that make it more handy for other types?
...
impl Bard {
    ...
    pub const ACE_SPADES:     Bard = Bard(0b1000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const ACE_HEARTS:     Bard = Bard(0b0100_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const ACE_DIAMONDS:   Bard = Bard(0b0010_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const ACE_CLUBS:      Bard = Bard(0b0001_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const KING_SPADES:    Bard = Bard(0b0000_1000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const KING_HEARTS:    Bard = Bard(0b0000_0100_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const KING_DIAMONDS:  Bard = Bard(0b0000_0010_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const KING_CLUBS:     Bard = Bard(0b0000_0001_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const QUEEN_SPADES:   Bard = Bard(0b0000_0000_1000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const QUEEN_HEARTS:   Bard = Bard(0b0000_0000_0100_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const QUEEN_DIAMONDS: Bard = Bard(0b0000_0000_0010_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const QUEEN_CLUBS:    Bard = Bard(0b0000_0000_0001_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const JACK_SPADES:    Bard = Bard(0b0000_0000_0000_1000_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const JACK_HEARTS:    Bard = Bard(0b0000_0000_0000_0100_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const JACK_DIAMONDS:  Bard = Bard(0b0000_0000_0000_0010_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const JACK_CLUBS:     Bard = Bard(0b0000_0000_0000_0001_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const TEN_SPADES:     Bard = Bard(0b0000_0000_0000_0000_1000_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const TEN_HEARTS:     Bard = Bard(0b0000_0000_0000_0000_0100_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const TEN_DIAMONDS:   Bard = Bard(0b0000_0000_0000_0000_0010_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const TEN_CLUBS:      Bard = Bard(0b0000_0000_0000_0000_0001_0000_0000_0000_0000_0000_0000_0000_0000);
    pub const NINE_SPADES:    Bard = Bard(0b0000_0000_0000_0000_0000_1000_0000_0000_0000_0000_0000_0000_0000);
    pub const NINE_HEARTS:    Bard = Bard(0b0000_0000_0000_0000_0000_0100_0000_0000_0000_0000_0000_0000_0000);
    pub const NINE_DIAMONDS:  Bard = Bard(0b0000_0000_0000_0000_0000_0010_0000_0000_0000_0000_0000_0000_0000);
    pub const NINE_CLUBS:     Bard = Bard(0b0000_0000_0000_0000_0000_0001_0000_0000_0000_0000_0000_0000_0000);
    pub const EIGHT_SPADES:   Bard = Bard(0b0000_0000_0000_0000_0000_0000_1000_0000_0000_0000_0000_0000_0000);
    pub const EIGHT_HEARTS:   Bard = Bard(0b0000_0000_0000_0000_0000_0000_0100_0000_0000_0000_0000_0000_0000);
    pub const EIGHT_DIAMONDS: Bard = Bard(0b0000_0000_0000_0000_0000_0000_0010_0000_0000_0000_0000_0000_0000);
    pub const EIGHT_CLUBS:    Bard = Bard(0b0000_0000_0000_0000_0000_0000_0001_0000_0000_0000_0000_0000_0000);
    pub const SEVEN_SPADES:   Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_1000_0000_0000_0000_0000_0000);
    pub const SEVEN_HEARTS:   Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0100_0000_0000_0000_0000_0000);
    pub const SEVEN_DIAMONDS: Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0010_0000_0000_0000_0000_0000);
    pub const SEVEN_CLUBS:    Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0001_0000_0000_0000_0000_0000);
    pub const SIX_SPADES:     Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_1000_0000_0000_0000_0000);
    pub const SIX_HEARTS:     Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0100_0000_0000_0000_0000);
    pub const SIX_DIAMONDS:   Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0010_0000_0000_0000_0000);
    pub const SIX_CLUBS:      Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0001_0000_0000_0000_0000);
    pub const FIVE_SPADES:    Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0000_1000_0000_0000_0000);
    pub const FIVE_HEARTS:    Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0100_0000_0000_0000);
    pub const FIVE_DIAMONDS:  Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0010_0000_0000_0000);
    pub const FIVE_CLUBS:     Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0001_0000_0000_0000);
    pub const FOUR_SPADES:    Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_1000_0000_0000);
    pub const FOUR_HEARTS:    Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0100_0000_0000);
    pub const FOUR_DIAMONDS:  Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0010_0000_0000);
    pub const FOUR_CLUBS:     Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0001_0000_0000);
    pub const TREY_SPADES:    Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_1000_0000);
    pub const TREY_HEARTS:    Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0100_0000);
    pub const TREY_DIAMONDS:  Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0010_0000);
    pub const TREY_CLUBS:     Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0001_0000);
    pub const DEUCE_SPADES:   Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_1000);
    pub const DEUCE_HEARTS:   Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0100);
    pub const DEUCE_DIAMONDS: Bard = Bard(0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0010);
...
mod bard_tests {
    ...
    fn bit_or() {
        let raw_as: u64 = 0b1000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000;
        let raw_ah: u64 = 0b0100_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000;
        let raw_aa = raw_as | raw_ah;
